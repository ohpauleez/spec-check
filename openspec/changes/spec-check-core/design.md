...
- Known capability names from the active catalog are provided as soft naming suggestions; the LLM may still create novel names for code not covered by existing specs.
